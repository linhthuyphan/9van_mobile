...
const AssignmentWait = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.assignmentWaitLayout}>
      <View style={[styles.trangChComponent, styles.assignmentWaitLayout]}>
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>3</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>4</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>5</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>6</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>7</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>8</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>9</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>10</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>11</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>12</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
            ...
            <View style={[styles.button2, styles.buttonSpaceBlock]}>
              <View style={styles.container2}>
                <Image
                  ...
                  source={require("../assets/icon-before1.png")}
                />
                <Text style={[styles.children2, styles.childrenTypo1]}>20</Text>
                <Image
                  style={[styles.iconAfter, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../assets/icon-before1.png")}
                ...
                <View>
                  <View style={styles.dropdownItemRadio}>
                    <View style={[styles.buttonitem, styles.buttonitemFlexBox]}>
                      <View
                        style={[styles.container25, styles.container25FlexBox]}
                      >
                        <Image
          ...
          <View style={styles.tableTree}>
            ...
            <View style={[styles.codePartsCell1, styles.codeBorder]}>
              <View style={[styles.container37, styles.containerFlexBox]}>
                <View style={styles.box}>
                  <Text style={[styles.cellLabel, styles.labelTypo]}>{`Học sinh
`}</Text>
                </View>
              </View>
              <View style={styles.minheightController40px} />
              ...
              <View style={styles.containerFlexBox}>
                <View style={styles.box}>
                  <Text style={[styles.cellLabel7, styles.cellTypo]}>
                    ...
                    thương về tinh thần và thể xác diễn ra trong phạm vi trường
                    học.
                  </Text>
                </View>
              </View>
...
`}</Text>
            ...
            <View style={[styles.codePartsCell, styles.codeBorder]}>
              <View style={styles.containerFlexBox}>
                <View style={styles.box}>
                  <Text style={[styles.cellLabel, styles.labelTypo]}>Điểm</Text>
                </View>
              </View>
              <View style={styles.minheightController40px} />
            </View>
...
09/01/2024 07:13`}</Text>
            ...
            <View style={[styles.codePartsCell, styles.codeBorder]}>
              <View style={styles.containerFlexBox}>
                <View style={styles.box}>
                  <Text style={[styles.cellLabel7, styles.cellTypo]}>
                    Học tủ, học vẹt là những hiện tượng tiêu cực, gây ảnh hưởng
                    xấu tới sự phát triển của cộng đồng. Hình thức học tập này
                    thực chất chỉ là sự qua loa, chống đối khi gần tới ngày kiểm
                    tra. Người học không thực sự hiểu và nắm bắt được kiến thức
                  </Text>
                </View>
              </View>
              <View style={styles.minheightController40px} />
        ...
        <View style={[styles.bngBiGiao2, styles.bngPosition]}>
          ...
          <View style={styles.tableTree4}>
            ...
            <View style={[styles.codePartsCell1, styles.codeBorder]}>
              <View style={[styles.container37, styles.containerFlexBox]}>
                <View style={styles.box}>
                  <Text style={[styles.cellLabel, styles.labelTypo]}>{`Thông tin
`}</Text>
                </View>
              </View>
              <View style={styles.minheightController40px} />
            ...
            <View style={[styles.codePartsCell, styles.codeBorder]}>
              <View style={styles.containerFlexBox}>
                <View style={styles.box}>
                  <Text style={[styles.cellLabel, styles.labelTypo]}>Lớp</Text>
                </View>
              </View>
              <View style={styles.minheightController40px} />
            </View>
