...
0 bài tập`}</Text>
      ...
      <View style={styles.classActive}>
        ...
        <View style={[styles.thngBoToThnhCong, styles.mtMoBg]}>
          <Image
            style={styles.thngBoToThnhCongChild}
            resizeMode="cover"
