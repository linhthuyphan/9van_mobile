...
const SaveProfile = () => {
  return (
    <View style={styles.saveProfile}>
      <View style={[styles.profile, styles.tiuPosition]}>
        <View style={[styles.ccChcNngKhc, styles.tiuPosition]}>
          ...
          <View style={[styles.dropdownMenu, styles.dropdownLayout]}>
            <View style={[styles.dropdownMenu1, styles.thngTinCnhBoShadowBox]}>
      ...
      <View style={[styles.mnHnhThngBo, styles.tiuPosition]}>
        <View style={styles.blanket} />
        <View style={[styles.thngTinCnhBo, styles.modalfooterPosition]}>
        ...
        <View style={[styles.modalfooter, styles.modalfooterPosition]}>
          <View style={[styles.button4, styles.buttonFlexBox]}>
            <View style={styles.container}>
              <Image
                style={[styles.iconBefore9, styles.iconLayout1]}
                ...
                source={require("../assets/icon-before1.png")}
              />
              <Text style={[styles.children13, styles.childrenTypo]}>Hủy</Text>
              <Image
                style={[styles.iconAfter, styles.iconLayout1]}
                resizeMode="cover"
                source={require("../assets/icon-before1.png")}
          ...
          <View style={[styles.lu, styles.buttonFlexBox]}>
            <View style={styles.container}>
              <Image
                style={[styles.iconBefore9, styles.iconLayout1]}
                resizeMode="cover"
